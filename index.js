...
const isOwner = [`${setting.ownerNumber}`,"6281226416919@s.whatsapp.net","6281226416919@s.whatsapp.net"].includes(sender) ? true : false
...
conn.sendMessage(from, { text: tampilan_nya, buttons: btn_menu, footer: footer_nya, mentions: [setting.ownerNumber, sender]}, { quoted: fkontak})
}
break
case 'verify':{
...
var ppnu = 'https://telegra.ph/Logo-01-09-5'
}
...
break
case 'infoupdate':
reply('Cek YouTube : http://youtube.com/@melliafriskal')
break
case 'script': case 'sc':
...
conn.sendMessage(from, { image: fs.readFileSync(`${setting.qrisNya}`),
 caption: tekssss, 
footer: `${setting.ownerName} © 𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊`,
buttons: button},
{ quoted: msg })
}
break
...
*Tercatat:* ${db_error.length}
*Type:* ${err}`
conn.sendMessage(`6281226416919@s.whatsapp.net`, {text:errny, mentions:[sender]})
}}